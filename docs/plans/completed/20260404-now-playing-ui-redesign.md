...
- [x] update README.md if new UI patterns should be documented
- [x] update CLAUDE.md with discovered layout calculation patterns
- [x] document the new helper functions and their usage
