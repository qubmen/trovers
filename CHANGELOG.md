...
## [0.1.2](https://github.com/qubmen/trovers/releases/tag/v0.1.2) - 2026-08-22
...
- hint at a yt-dlp update when YouTube blocks playback/download
...
- manually bump version to 0.1.2
- release v0.1.1
